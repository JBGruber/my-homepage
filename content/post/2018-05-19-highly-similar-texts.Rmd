...
This post describes a strategy we came up with to effectivly find those highly similar articles.
...
This is an `r scales::comma(as.numeric(benchmark$mean[2]) / as.numeric(benchmark$mean[1]))`% increase on average.

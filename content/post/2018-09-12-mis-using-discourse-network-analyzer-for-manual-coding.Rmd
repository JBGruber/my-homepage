...
When I was done coding, re-import of the data into R had again to go through intermediate file, although this time it was relatively easy as qcamap employs the CSV file format.
...
***1. It's integration into 'R' is pretty good.***
...
![DNA in action](/post/2018-09-12-mis-using-discourse-network-analyzer-for-manual-coding_files/DNA.png)

Even though ´DNA´ was developed for using it with a specific method (discourse network analysis) and I won't be using that, I think that at least for me it is the best choice.
